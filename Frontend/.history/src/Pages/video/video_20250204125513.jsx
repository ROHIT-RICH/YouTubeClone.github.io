      ...
      <div className="videoSuggestions">
        <div className="videoSuggentionBlock">
            ...
            <div className="videoSuggestionAbout">
                <div className="videoSuggestion-aboutTitle">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Excepturi eveniet cumque illum accusamus vel animi omnis beatae repellat dolorum, iure fugiat enim maxime dolor in a unde ipsa praesentium esse.</div>
            </div>
        </div>
      </div>
    </div>
