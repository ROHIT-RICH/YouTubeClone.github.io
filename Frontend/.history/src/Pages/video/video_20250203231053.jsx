        ...
        <div className="video">
            <div className="videopost-Section">
                ...
                <div className="video-about">
                    ...
                    <div className="videoProfile-blockLeft"></div>
                    <div className="videoProfile-leftSide">
                        <div className="videoProfileI-leftImg">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQn3N-JXZrh8nMyM-0uh68TbLYUBYqAM3EwQQ&s" alt="profile" className="videoProfile-Img" />
                        </div>
                    </div>
                </div>
            </div>
