        ...
        <div className="video-about">
          ...
          <div className="videoProfile-block">
            <div className="videoProfile-leftSide">
              <Link to={'/user/1'} className="videoProfileI-leftImg">
                <img
      ...
      <div className="videoSuggestions">
        ...
        <div className="videoSuggentionBlock">
            ...
            <div className="videoSuggestionAbout">
                <div className="videoSuggestion-aboutTitle">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</div>
                <div className="videoSuggestion-aboutProfile">Cricket 320</div>
                <div className="videoSuggestion-aboutProfile">136k views . 1 day ago</div>
            </div>
        </div>
