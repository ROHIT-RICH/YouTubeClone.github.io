        ...
        <div className="videoUpload">
            <div className="uploadBox">
                ...
                <div className="uploadForm">
                    ...
                    <input type="text" className="uploadFormInputs" onChange={(e)=>handleOnchange(e,"title")} placeholder="Description" />
                    <input type="text" className="uploadFormInputs" onChange={(e)=>handleOnchange(e,"title")} placeholder="Category" />
