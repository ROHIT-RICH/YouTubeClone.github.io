        ...
        <div className="videoUpload">
            <div className="uploadBox">
                ...
                <div className="uploadForm">
                    ...
                    <div className="file">Thumbnail &nbsp; <input type="file" onChange={(e)=> imageUpload(e, "im")} accept="image/*" /></div>
                    <div className="file">Video &nbsp; <input type="file" onChange={(e)=> imageUpload(e)} accept="video/mp4, video/webm, video/*" /></div>
