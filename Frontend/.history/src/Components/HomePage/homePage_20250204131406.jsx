  ...
  return (
    <div className={sideNav ? "homePage" : "homepage-full"}>
      ...
      <div className={sideNav ? "home-mainPage" : "home-mainPagefull"}>
        ...
        <Link to={'/watch/1'} className="youtube-video">
          ...
          <div className="youtube-titleBox">
            ...
            <div className="youtube-titleBox-title">
                <div className="youtube-videoTitle">User 1</div>
                <div className="youtube-channelName">@ User 1</div>
                <div className="youtubeVideos-views">3 Likes</div>
            </div>
          </div>
