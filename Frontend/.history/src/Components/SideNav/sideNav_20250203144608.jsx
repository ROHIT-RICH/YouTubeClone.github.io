  ...
  return (
    <div className="home-sidenav">
      ...
      <div className="home-sidenav-bottom">
        ...
        <div className="home-sidenav-topOption">
          <img className="home-sidenav-Imglogo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSShdDyUiXauovuZb90_6n-Ve9sLhqlIcxorg&s" alt="lo" />
          <div className="home-sidenav-topOption-title">Aaj Tak</div>
        </div>

        <div className="home-sidenav-topOption">
          <img className="home-sidenav-Imglogo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCsGk8Hk8ObfsNGMZlhWHXFpQqpQmOCFXGUQ&s" alt="" />
          <div className="home-sidenav-topOption-title">DNA News</div>
        </div>

        <div className="home-sidenav-topOption">
          <img className="home-sidenav-Imglogo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJQpn0BWcniRi_eOvp7WDW73Uyn_E-mgZwrA&s" alt="" />
