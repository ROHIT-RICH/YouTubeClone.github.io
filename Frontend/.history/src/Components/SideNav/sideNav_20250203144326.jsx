  ...
  return (
    <div className="home-sidenav">
      ...
      <div className="home-sidenav-bottom">
        ...
        <div className="home-sidenav-topOption">
          <img className="home-sidenav-Imglogo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSShdDyUiXauovuZb90_6n-Ve9sLhqlIcxorg&s" alt="" />
          <div className="home-sidenav-topOption-title">Aaj Tak</div>
        </div>

        <div className="home-sidenav-topOption">
          <img className="home-sidenav-Imglogo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPG4GEpJ-9T20E2P2CzmWLQrjopJXAY_b16w&s" alt="" />
